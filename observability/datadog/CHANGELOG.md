...
- Updated dependencies [[`2d1ec9e`](https://github.com/mastra-ai/mastra/commit/2d1ec9e6e349c7f05555a2ffcc79308cd96f48e2)]:
...
- dependencies updates: ([#19783](https://github.com/mastra-ai/mastra/pull/19783))
  - Updated dependency [`dd-trace@^5.117.0` ↗︎](https://www.npmjs.com/package/dd-trace/v/5.117.0) (from `^5.108.0`, in `dependencies`)
...
- Released bridge state for spans that end without being exported. ([#20463](https://github.com/mastra-ai/mastra/pull/20463))
...
- dependencies updates: ([#17846](https://github.com/mastra-ai/mastra/pull/17846))
  - Updated dependency [`dd-trace@^5.108.0` ↗︎](https://www.npmjs.com/package/dd-trace/v/5.108.0) (from `^5.89.0`, in `dependencies`)
...
- Fixed error spans showing as [object Object] in Datadog UI. The exporter now sets native dd-trace error tags (error.message, error.type, error.stack) so Datadog's Error Tracking UI displays the full error banner with message, type, and stack trace. ([#14944](https://github.com/mastra-ai/mastra/pull/14944))
...
- Fixed Datadog request context keys so they are exported as flat LLM Observability tags instead of nested metadata. ([#14789](https://github.com/mastra-ai/mastra/pull/14789))
