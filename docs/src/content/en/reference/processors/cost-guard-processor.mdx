...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    defaultValue: "'Cost guard: estimated cost limit exceeded ({usage}/{limit})'",
  },
  {
    name: 'warnAtPercent',
    type: 'number',
